...
local _loadXp = function(clientNum)
    ...
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[BATTLESENSE+1])  , BATTLESENSE  , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[ENGINEERING+1])  , ENGINEERING  , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[MEDIC+1])        , MEDIC        , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[FIELDOPS+1])     , FIELDOPS     , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[LIGHTWEAPONS+1]) , LIGHTWEAPONS , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[HEAVYWEAPONS+1]) , HEAVYWEAPONS , 0)
    et.G_XP_Set( clientNum, _int(XP[GUID].skills[COVERTOPS+1])    , COVERTOPS    , 0)
